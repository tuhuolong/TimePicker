...
public class NumberPicker extends LinearLayout {
    ...
    private static final int[] PRESSED_STATE_SET = new int[] {
    ...
    public NumberPicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        final TypedArray a = getContext().obtainStyledAttributes(attrs, MiuiNumberPicker_Styleable,
                0, 0);
        ...
        mInputText.setPadding(TEXT_PADDING, mInputText.getPaddingTop(), TEXT_PADDING,
    ...
    protected boolean dispatchHoverEvent(MotionEvent event) {
        ...
        AccessibilityManager acm = (AccessibilityManager) getContext().getSystemService(
    ...
    /**
     * Set the lable of the NumberPicker. Set null or empty string to remove
     * label.
     * 
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mVirtualButtonPressedDrawable != null
            ...
            if (mDecrementVirtualButtonPressed) {
                ...
                mVirtualButtonPressedDrawable.setBounds(paddingLeft, 0, w - paddingRight,
                        mTopSelectionDividerTop);
                mVirtualButtonPressedDrawable.draw(canvas);
            }
            if (mIncrementVirtualButtonPressed) {
                mVirtualButtonPressedDrawable.setState(PRESSED_STATE_SET);
                mVirtualButtonPressedDrawable.setBounds(paddingLeft, mBottomSelectionDividerBottom,
                        w - paddingRight,
                        getBottom());
                mVirtualButtonPressedDrawable.draw(canvas);
            }
        ...
        float centerY = mInitialScrollOffset + SELECTOR_WHEEL_ITEM_COUNT / 2
        ...
        for (int selectorIndex : selectorIndices) {
            ...
            mSelectorWheelPaint.setColor(getAlphaGradient(posy, /* TEXT_COLOR_BG */0x7f000000,
                    false));
            canvas.drawText(scrollSelectorValue, x, y + (sizeFg - TEXT_SIZE_MIN) / 2.0f,
                    mSelectorWheelPaint);
            if (posy < 1) {
                mSelectorWheelPaint.setColor(getAlphaGradient(posy,
                        getResources().getColor(R.color.class_text_14)/* TEXT_COLOR_FG */, true));
                canvas.drawText(scrollSelectorValue, x, y + (sizeFg - TEXT_SIZE_MIN) / 2.0f,
                        mSelectorWheelPaint);
            }
